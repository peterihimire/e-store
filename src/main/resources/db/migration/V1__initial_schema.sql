    ...
    create table orders (
        ...
        payment_status varchar(255) not null check (payment_status in ('UNPAID','PENDING','PAID','FAILED','REFUNDED','PARTIALLY_REFUNDED')),
        slug varchar(255) not null unique,
    ...
    create table payments (
        ...
        payment_method varchar(255) not null check (payment_method in ('PAYSTACK','CARD','BANK_TRANSFER','USSD','WALLET','CASH_ON_DELIVERY')),
        payment_status varchar(255) not null check (payment_status in ('UNPAID','PENDING','PAID','FAILED','REFUNDED','PARTIALLY_REFUNDED')),
